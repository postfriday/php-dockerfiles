...
build-8.2-cli-dev: ## Build PHP 8.2 CLI Development
	make build PHP_VERSION=8.2 PHP_MODE=cli PHP_ENVIRONMENT=development

.PHONY: run-8.2-cli-dev
run-8.2-cli-dev: ## Run PHP 8.2 CLI Development
	make run PHP_VERSION=8.2 PHP_MODE=cli PHP_ENVIRONMENT=development

.PHONY: build-8.2-fpm-dev
build-8.2-fpm-dev: ## Build PHP 8.2 FPM Development
	make build PHP_VERSION=8.2 PHP_MODE=fpm PHP_ENVIRONMENT=development

.PHONY: run-8.2-fpm-dev
run-8.2-fpm-dev: ## Run PHP 8.2 FPM Development
	make run PHP_VERSION=8.2 PHP_MODE=fpm PHP_ENVIRONMENT=development

.PHONY: build-8.2-cli-prod
build-8.2-cli-prod: ## Build PHP 8.2 CLI Production
	make build PHP_VERSION=8.2 PHP_MODE=cli PHP_ENVIRONMENT=production

.PHONY: run-8.2-cli-prod
run-8.2-cli-prod: ## Run PHP 8.2 CLI Production
	make run PHP_VERSION=8.2 PHP_MODE=cli PHP_ENVIRONMENT=production

.PHONY: build-8.2-fpm-prod
build-8.2-fpm-prod: ## Build PHP 8.2 FPM Production
	make build PHP_VERSION=8.2 PHP_MODE=fpm PHP_ENVIRONMENT=production

.PHONY: run-8.2-fpm-prod
run-8.2-fpm-prod: ## Run PHP 8.2 FPM Production
	make run PHP_VERSION=8.2 PHP_MODE=fpm PHP_ENVIRONMENT=production
